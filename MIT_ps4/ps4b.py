...
class Message(object):
    ...
    def apply_shift(self, shift):
        ...
        for i, char in enumerate(self.message_text):
            if char.isalpha():
                new_text += dict_shift[char]
            else:
                new_text += self.message_text[i]
...
class CiphertextMessage(Message):
    ...
    def decrypt_message(self):
        ...
        for shift in range(0, 27):
            temp_message = self.apply_shift(shift)
            ...
            real_words_temp = 0
        return best_shift, updated_message
